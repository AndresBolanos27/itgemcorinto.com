<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Asignar Cargas Académicas para el Grupo: ') }} {{ $group->nombre }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <a href="{{ route('groups.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                    ...
                    <div>
                        ...
                        @if($currentLoads->isEmpty())
                            <p class="text-sm text-gray-500">Este grupo no tiene cargas académicas asignadas.</p>
                        @else
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($currentLoads as $load)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900">{{ $load->subject->nombre }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
